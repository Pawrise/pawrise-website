export const SHELL = `
  ...
  <aside class="panel" id="pPres">
    ...
    <div class="pb">
      ...
      <div class="pcard" style="--ac:var(--rose)"><h3>🩸 Marché GPS saturé</h3><p>Tractive, PetPace, capitalisés.</p><div class="answer"><b>Réponse :</b> pivot océan-bleu vété (PDF normalisé).</div></div>
      <div class="eyebrow">Modèle économique</div>
      <div class="pcard" style="--ac:var(--data)"><table class="eco"><tr><th>Métrique</th><th>Opt.</th><th>Base</th><th>Pess.</th></tr><tr><td>Marge brute</td><td class="good">89%</td><td class="good">69%</td><td class="bad">21%</td></tr><tr><td>LTV:CAC</td><td class="good">22×</td><td class="good">5,4×</td><td class="bad">0,4×</td></tr><tr><td>Payback</td><td>2 m</td><td>6 m</td><td class="bad">42 m</td></tr></table><div class="answer"><b>Pool façon Spotify</b> : part fixe d'abo → coût vété plafonné par construction.</div></div>

...
// React Bits — Aurora (WebGL/OGL). Adapté : 'use client', garde de montage,
// pas d'import CSS (la classe .aurora-container est dans globals.css).
...
export default function Aurora({
  colorStops = ["#01aabb", "#d3fc72", "#37338f"],
  amplitude = 1.1,
  blend = 0.5,
  speed = 0.8,
}: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const stopsArr = propsRef.current.colorStops.map((hex) => {

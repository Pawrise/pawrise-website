...
"use client";
/* eslint-disable */
// React Bits — StaggeredMenu (port fidèle, TS).
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Navigation">
        <a href="/" className="sm-logo" aria-label="Accueil">
          <img src={logoUrl} alt="Logo" className="sm-logo-img" draggable={false} width={34} height={34} />
          <b style={{ color: "#fff", marginLeft: 10, fontWeight: 800 }}>Pawrise Care</b>
        </a>
        <button ref={toggleBtnRef} className="sm-toggle" aria-label={open ? "Fermer" : "Menu"} aria-expanded={open} onClick={toggleMenu} type="button">
